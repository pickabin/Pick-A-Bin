...
class PickPointKoordinatorPage extends StatefulWidget {
  const PickPointKoordinatorPage({Key? key}) : super(key: key);

  @override
  State<PickPointKoordinatorPage> createState() => _PickPointKoordinatorState();
}

class _PickPointKoordinatorState extends State<PickPointKoordinatorPage> {
            ...
            child: ElevatedButton(
                ...
                onPressed: () {
                  ...
                  Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                          builder: (context) => RegisterKoordinatorPage(
                                // location: location,
                                // lat: lat,
                                // long: long,
                              )));
