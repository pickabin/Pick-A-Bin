...
class PickPointWargaPage extends StatefulWidget {
  const PickPointWargaPage({Key? key}) : super(key: key);

  @override
  State<PickPointWargaPage> createState() => _PickPointWargaState();
}
            ...
            child: ElevatedButton(
                ...
                onPressed: () {
                  ...
                  Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                          builder: (context) => RegisterWargaPage(
                                location: location,
                                lat: lat,
                                long: long,
                              )));
