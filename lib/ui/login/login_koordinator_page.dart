...
class LoginKoordinatorPage extends StatefulWidget {
  @override
  State<LoginKoordinatorPage> createState() => _LoginKoordinatorPageState();
}

class _LoginKoordinatorPageState extends State<LoginKoordinatorPage> {
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (authService.email.text.isEmpty) {
                                      ...
                                      if (authService.password.text.isEmpty) {
                                        ...
                                        authService.loginUserKoordinator(context);
