...
class AreaIdPetugas extends StatefulWidget {
  String? code;
  String? cleanArea;
  AreaIdPetugas({Key? key, required this.code}) : super(key: key);

  @override
  _AreaIdPetugasState createState() => _AreaIdPetugasState();
}

class _AreaIdPetugasState extends State<AreaIdPetugas> {
  final GlobalKey<FormState> _formKey = new GlobalKey();
  var kodeGedungController =
        new TextEditingController(text: global.code);
  var namaTempatController = new TextEditingController();
  String? role;
  // isCode tipe bool
  bool isCode = false;
                            ...
                            TextButton(
                              ...
                              onPressed: () {
                                if (_formKey.currentState!.validate()) {
                                  PetugasController()
                                      .getCekCode(kodeGedungController.text)
                                      .then((value) {
                                    print("value $value");
                                    if (value == "1") {
                                      setState(() {
                              ...
                              child: isCode
                                  ? ElevatedButton(
                                      onPressed: () async {
                                        ...
                                        print("Ini role $role");
                                        if (_formKey.currentState!.validate()) {
                                          if (kodeGedungController
                                                  .text.isNotEmpty ||
                                              namaTempatController
                                                  .text.isNotEmpty) {
                                              ...
                                              if (role == 'petugas') {
                                                JadwalController
                                                  ...
                                                  if (value.statusCode == 200) {
                                                    ...
                                                    Fluttertoast.showToast(
                                                        ...
                                                        fontSize: 16.0);
                                                        setState(() {
                                                          global.code = kodeGedungController.text;
                                                        });
                                                  } else {
                                                    Fluttertoast.showToast(
                                                        msg:
                                                            "Update Jadwal code petugas Failed",
                                                        toastLength:
                                                            Toast.LENGTH_SHORT,
                                                        gravity:
                                                            ToastGravity.BOTTOM,
                                                ...
                                                JadwalController
                                                  ...
                                                  if (value.statusCode == 200) {
                                                    ...
                                                    Fluttertoast.showToast(
                                                        msg:
                                                            "Update Jadwal code koor Failed",
                                                        toastLength:
                                                            Toast.LENGTH_SHORT,
                                                        gravity:
                                                            ToastGravity.BOTTOM,
