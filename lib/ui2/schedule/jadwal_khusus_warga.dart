...
class JadwalKhususWarga extends StatefulWidget {
  final String? uid;
  JadwalKhususWarga({Key? key, required this.uid}) : super(key: key);

  @override
  State<JadwalKhususWarga> createState() => _JadwalKhususWargaState();
}

class _JadwalKhususWargaState extends State<JadwalKhususWarga> {
